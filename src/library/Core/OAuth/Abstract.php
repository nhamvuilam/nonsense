...
abstract class Core_OAuth_Abstract {
    ...
    public function process() {
        if (isset($_REQUEST[$this->getAuthorizationKey()])) {
            ...
            if (!isset($_SESSION[$this->getCrsfKey()]) || ($this->version == 2 && $_REQUEST[$this->getCrsfKey()] != $_SESSION[$this->getCrsfKey()])) {
