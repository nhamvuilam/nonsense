...
/**
 * Class that handle the oauth process with Twitter provider
 * Note that this class use OAuth version 1 and it use the OAuth library to communicate with provider
 */
class Core_OAuth_Twitter extends Core_OAuth_Abstract {
    protected $version = 1;
	protected  $consumerKey = 'Irvt8aMFhtlycfj2IxbA';
	protected  $consumerSecret = 'xlnuq4LhToZPkJ4v4m02W2mjrZGjbvluH0nu0RHmA';
