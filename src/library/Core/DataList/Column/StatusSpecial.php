<?php
class Core_DataList_Column_StatusSpecial extends Core_DataList_Column_Abstract
{
	public $name;
	...
	public function renderDataCellContent($row, $data){		
		...
		if(!empty($data[$this->primary]) && !empty($this->updateUrl)){					
			$options['onClick'] = "jQuery.fn.DataList.post('{$this->grid->id}', {url: '{$this->updateUrl}',data: {'type':'special', 'data':{$data[$this->primary]}}});";
		}		
