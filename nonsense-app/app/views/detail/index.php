					...
					<header>
						<h2 class="badge-item-title">
						  <a class="badge-evt badge-track" href="javascript:void(0);">
						     <?php echo $data['posts']['content']['caption']?>
						  </a>
						</h2>
					</header>
					<div class="badge-post-container post-container">
						<a href="javascript:void(0);">
                            <img class="badge-item-img" src="<?php echo ($data['posts']['type'] == 'image' ? $data['posts']['content']['images']['medium']['url'] : $data['posts']['content']['image_url']) ?>" alt="<?php echo $data['posts']['image']['caption']?>" />
						</a>
					</div>
					<p class="post-meta">
