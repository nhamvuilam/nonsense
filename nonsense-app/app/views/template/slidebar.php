		...
		<form method="post" action="/profile/setcustomize" id="jsid-personalise-form">
			<section class="section-control" id="jsid-personalise-selector" style="display: none;">
				...
				<div class="btn-container">
					<a class="btn size-30 blue" href="#" id="jsid-personalise-btn-save">Save</a><a class="link" href="#" id="jsid-personalise-btn-reset">Reset</a>
				</div>
			</section>
		...
		<div id="sidebar-content">
			...
			<div id="jsid-featured-sidebar-tail">
				...
				<section class="block-subscribe badge-email-subscription" style="padding-bottom: 20px;">
					...
					<form>
						<div class="field badge-toggle-hide-when-done">
							...
							type="email" placeholder="Email address">
							<a class="btn badge-email-subscription-btn badge-evt" href="javascript:void(0);"
							data-evt="Email-Subscription,Input-Clicked,bottom">Subscribe</a>
						</div>
						<div class="message hide badge-toggle-hide-when-done">
							<p>
								Thanks for signing up!
				...
				<section class="get-the-app">
					...
					<ul>
						<li>
							<a class="app-store" href="http://9gag.com/iphone" target="_blank" onClick="GAG.GA.track('iPhone-App', 'Clicked-Download', 'SidNavBanner');">Download on App Store</a>
						</li>
						<li>
							<a class="google-play" href="http://9gag.com/android" target="_blank" onClick="GAG.GA.track('Android-App', 'Clicked-Download', 'SidNavBanner');">Get it on Google Play</a>
						</li>
					</ul>
				</section>
				<section class="footer">
					<p class="static">
						<a href="http://9gag.com/advertise">Advertise</a> &middot; <a href="http://9gag.com/contact">Contacts</a> &middot; <a href="http://9gag.com/privacy">Privacy</a> &middot; <a href="http://9gag.com/tos">Terms</a>
					</p>
					<p class="static">
						9GAG &copy; 2014
					</p>
